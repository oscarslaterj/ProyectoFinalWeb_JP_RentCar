<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cRenta.aspx.cs" Inherits="ProyectoFinalWeb_JPRentACar.UI.Consultas.cRenta" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">

     <h3>Consulta de Renta</h3>
    <div class="form-row justify-content-center">
        ...
        <div class="form-group col-md-2">
            ...
            <asp:DropDownList ID="FiltroDropDownList" CssClass="form-control" runat="server">
                ...
                <asp:ListItem>Renta ID</asp:ListItem>
    ...
    <div class="form-row justify-content-center">
        <asp:GridView ID="ReentaGridView" runat="server" class="table table-condensed table-bordered table-responsive"
            AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
            <AlternatingRowStyle BackColor="SkyBlue" />
            <Columns>
                <asp:BoundField DataField="RentaId" HeaderText="Vehiculo Id" />
